...
#define DMX_UNIVERSE_MAX_170_PIXELS		(170)
#define DMX_RGB_MAX_510_BYTES			(510)
#define RGB_3BYTES						(3)
...
// LED output pins
#define WS2812B_PINS (GPIO_PIN_3 | GPIO_PIN_4)
// How many LEDs are in the series
#define WS2812B_NUMBER_OF_LEDS 		DMX_UNIVERSE_MAX_170_PIXELS
