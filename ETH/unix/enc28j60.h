...
#define ENC28J60_NO_SELECT()		GPIO_SetBits( ENC28J60_CS_PORT, ENC28J60_CS_PIN );  
#define ENC28J60_SELECT()			GPIO_ResetBits( ENC28J60_CS_PORT, ENC28J60_CS_PIN );

/*RST Pin Definition*/
#define ENC28J60_RST_PORT			GPIOA
#define ENC28J60_RST_CLK			RCC_APB2Periph_GPIOA
#define ENC28J60_RST_PIN			GPIO_Pin_8
#define ENC28J60_RST_SET()			GPIO_SetBits( ENC28J60_RST_PORT, ENC28J60_RST_PIN );  
#define ENC28J60_RST_CLEAR()		GPIO_ResetBits( ENC28J60_RST_PORT, ENC28J60_RST_PIN );
